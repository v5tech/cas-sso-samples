...
<div class="box" id="login">
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <section class="row">
      ...
      <img alt="<spring:message code="required.captcha" />" onclick="this.src='captcha.jpg?'+Math.random()" width="93" height="30" src="captcha.jpg" style="vertical-align: middle;">
    ...
    <!-- rememberMe -->
    <section class="row">
      <input type="checkbox" name="rememberMe" id="rememberMe" value="true" /><spring:message code="rememberMe" />
    </section>
